...
class ReturnExchangeForm extends StatefulWidget {
...
const ReturnExchangeForm({ 
  ...
  @override
  State<ReturnExchangeForm> createState() => _ReturnExchangeFormState();
}

class _ReturnExchangeFormState extends State<ReturnExchangeForm> {

  Future<void> returnByExhange()async{
    final id = prodIDcontrol.text;
    final name = nameControl.text;
    final customerName = customerNamecontrol.text;
    const comments = 'RETURN IN EXCHANGE';
    ...
    final response = await http.post(
      Uri.parse(returnInExchangeStockRoute),
  ...
  Widget build(BuildContext context){
    ...
    return Scaffold(
      appBar: AppBar(
        ...
        title: const Text('Return for exchange form'),
      ), 
      body: Form(
        key: formKey,
        child: Column(
